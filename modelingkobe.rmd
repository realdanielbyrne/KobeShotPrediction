...
#### Continuours Variables

We combined the following continuous variables into their principle components to include in out final model.

```{r}
#time_remaining attendance arena_temp avgnoisedb
#par(mfrow=c(1,3))
#boxplot(kobe$attendance, xlab="Attendance",col=kobe$attendance)
#boxplot(kobe$arena_temp, xlab="Arena Temperature",col=kobe$arena_temp)
#boxplot(kobe$time_remaining,xlab="Time Remaining(s)",col=kobe$time_remaining)
```
![](./images/time_plyoff_dist.png)
